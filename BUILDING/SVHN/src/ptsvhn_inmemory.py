...
from .svhn_utils import load_svhn_shard


class PyTorchSVHNInMemory(PyTorchDataLoader):
    """PyTorch data loader for SVHN dataset."""
    ...
    def __init__(self, data_path, batch_size, **kwargs):
        ...
        num_classes, X_train, y_train, X_valid, y_valid = load_svhn_shard(
