...
from .cifar100_utils import load_cifar100_shard


class PyTorchCIFAR100InMemory(PyTorchDataLoader):
    """PyTorch data loader for CIFAR100 dataset."""
    ...
    def __init__(self, data_path, batch_size, **kwargs):
        ...
        num_classes, X_train, y_train, X_valid, y_valid = load_cifar100_shard(
